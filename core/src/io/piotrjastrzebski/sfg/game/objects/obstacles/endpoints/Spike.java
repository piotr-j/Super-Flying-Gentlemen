...
public class Spike extends EndPoint {
    ...
    public Spike(){
        ...
        final SkeletonData skeletonData = assets.getSkeletonData(Assets.Animations.OBST_SPIKE);
        skeleton = new Skeleton(skeletonData);
        animation = skeletonData.findAnimation("trigger");
        animationState = new AnimationState(assets.getAnimationStateData(Assets.Animations.OBST_SPIKE));
